...
/**
 * @file
 * Contains \Drupal\mac_tools\Plugin\Block\MacToolsContactExtended.
 */
...
class MacToolsContactExtended extends BlockBase {
  ...
  public function defaultConfiguration() {
    return array(
      ...
      'contact_extended_markup_string' => $this->default_markup,
      'cache' => array(
        'max_age' => 3600,
        'contexts' => array(
  ...
  public function blockForm($form, FormStateInterface $form_state) {
    $form['contact_extended_markup_string_text'] = array(
      '#type' => 'textarea',
